/**
 * @file src/base/base_source_component.h
 * 
 ...
 */
DERIVEDCLASS(base_source_component_PrivateType, base_component_PrivateType)
#define base_source_component_PrivateType_FIELDS base_component_PrivateType_FIELDS \
	/** @param BufferMgmtCallback function pointer for algorithm callback */ \
	void (*BufferMgmtCallback)(stComponentType* stComponent, OMX_BUFFERHEADERTYPE* outputbuffer);
ENDCLASS(base_source_component_PrivateType)

/* Component private entry points declaration */
OMX_ERRORTYPE base_source_component_Constructor(stComponentType*);
