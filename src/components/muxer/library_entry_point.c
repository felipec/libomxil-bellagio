/**
  @file src/components/mux/library_entry_point.c
...
int omx_component_library_Setup(stLoaderComponentType **stComponents) {
  ...
  strcpy(stComponents[0]->name, "OMX.st.mux.3gp");
  stComponents[0]->name_specific_length = 1; 
  stComponents[0]->constructor = omx_mux_component_Constructor;
  ...
  strcpy(stComponents[0]->name_specific[0], "OMX.st.mux.3gp");
  strcpy(stComponents[0]->role_specific[0], "mux.3gp");
