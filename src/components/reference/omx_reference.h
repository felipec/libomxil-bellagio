...
typedef struct reference_PortType{
 ...
 */
typedef struct reference_PrivateType{
	/// @param inputPort Input port of the component
	reference_PortType inputPort;
	/// @param outputPort Output port of the component
	reference_PortType outputPort;
 ...
 */
OMX_ERRORTYPE reference_Constructor(stComponentType*);
 ...
 */
OMX_ERRORTYPE reference_DoStateSet(stComponentType*, OMX_U32);
