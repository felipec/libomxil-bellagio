/**
  @file src/loaders/loaders_linux/st_base_component_loader.h
 ...
 * This name of this function is the same for any dynamic component
 * loader and it is used as entry point for the loader of loaders
 */
